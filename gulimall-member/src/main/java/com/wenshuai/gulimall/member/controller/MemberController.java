package com.wenshuai.gulimall.member.controller;

import java.util.Arrays;
import java.util.Map;

import com.wenshuai.gulimall.member.feign.CouponFeignService;
...
import com.wenshuai.gulimall.member.service.MemberService;
